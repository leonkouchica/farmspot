                    ...
                    <div className="col-xxl-3 col-lg-4 col-sm-6">
                        <div className="vendor-card text-center px-16 pb-24">
                            <div className="">
                                ...
                                />
                                <h6 className="title mt-32">Organic Farmer</h6>
                        ...
                        <div className="vendor-card text-center px-16 pb-24">
                            <div className="">
                                <img
                                    ...
                                    className="vendor-card__logo m-12"
                                />
                                <h6 className="title mt-32">Safeway Farmer</h6>
                                <span className="text-heading text-sm d-block">
                                    Delivery by 6:15am
                                </span>
                                <Link
                        ...
                        <div className="vendor-card text-center px-16 pb-24">
                            <div className="">
                                <img
                                    ...
                                    className="vendor-card__logo m-12"
                                />
                                <h6 className="title mt-32">Max Farmer</h6>
                                <span className="text-heading text-sm d-block">
                                    Delivery by 6:15am
                                </span>
                                <Link
                        ...
                        <div className="vendor-card text-center px-16 pb-24">
                            <div className="">
                                <img
                                    ...
                                    className="vendor-card__logo m-12"
                                />
                                <h6 className="title mt-32">HRmart Farmer</h6>
                                <span className="text-heading text-sm d-block">
                                    Delivery by 6:15am
                                </span>
                                <Link
                        ...
                        <div className="vendor-card text-center px-16 pb-24">
                            <div className="">
                                <img
                                    ...
                                    className="vendor-card__logo m-12"
                                />
                                <h6 className="title mt-32">LR Farmer</h6>
                                <span className="text-heading text-sm d-block">
                                    Delivery by 6:15am
                                </span>
                                <Link
                        ...
                        <div className="vendor-card text-center px-16 pb-24">
                            <div className="">
                                <img
                                    ...
                                    className="vendor-card__logo m-12"
                                />
                                <h6 className="title mt-32">Foodsco Farmer</h6>
                                <span className="text-heading text-sm d-block">
                                    Delivery by 6:15am
                                </span>
                                <Link
